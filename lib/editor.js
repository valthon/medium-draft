...
var BUTTON_SHAPE = _propTypes2.default.shape({
...
var MediumDraftEditor = function (_React$Component) {
  ...
  function MediumDraftEditor(props) {
    ...
    _this.setLink = function (url) {
      return _this.updateEditorState(function (editorState) {
        var selection = editorState.getSelection();
        var content = editorState.getCurrentContent();
        var entityKey = null;
        var newUrl = url;
        var newEditorState = editorState;
        if (_this.props.processURL) {
          newUrl = _this.props.processURL(url);
    ...
    _this.updateEditorState = function (transformerOrState) {
      return _this.onChange(typeof transformerOrState === 'function' ? transformerOrState(_this.props.editorState) : transformerOrState, _this.focus);
    };
    ...
    */
    value: function render() {
      ...
      var _props = this.props,
          ...
          maxOverhang = _props.maxOverhang;
...
MediumDraftEditor.propTypes = {
  ...
  blockButtons: _propTypes2.default.arrayOf(BUTTON_SHAPE),
  inlineButtons: _propTypes2.default.arrayOf(BUTTON_SHAPE),
  customButtons: _propTypes2.default.arrayOf(BUTTON_SHAPE),
